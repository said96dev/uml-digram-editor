      ...
      <div className="relative z-10 container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-screen">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
            Create beautiful UML diagrams with an intuitive, touch-optimized interface
          </p>
        </motion.div>
              ...
              {features.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all ${
                    index === activeFeature ? "bg-white scale-125" : "bg-gray-500 opacity-50"
                  }`}
                />
              ))}
            </div>
        ...
        >
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all">
            ...
            <p className="text-gray-300">Drag and drop elements with intuitive touch controls and gestures</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all">
            ...
            <p className="text-gray-300">Support for all standard UML diagram types with specialized elements</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all">
            ...
            <p className="text-gray-300">Automatically save your diagrams locally for easy access later</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="mt-4 text-gray-400">No account required. Your diagrams are saved locally.</p>
        </motion.div>
      </div>
    </div>
  )
