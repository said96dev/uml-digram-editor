...
export function UMLToolbar({ diagramType }: UMLToolbarProps) {
  ...
  const onDragStart = useCallback((event: React.DragEvent<HTMLDivElement>, nodeType: string, data: any = {}) => {
    ...
    switch (diagramType) {
        ...
        return (
          <div className="grid grid-cols-2 gap-2">
            ...
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-blue-50 hover:bg-blue-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "useCase", { name: "Use Case" })}
            >
            ...
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-yellow-50 hover:bg-yellow-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "sticky", { text: "Add your notes here..." })}
            >
      ...
      case DiagramType.Sequence:
        return (
          <div className="grid grid-cols-2 gap-2">
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-cyan-50 hover:bg-cyan-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "lifeline", { name: "Object" })}
            >
              <Box className="h-8 w-8 text-cyan-600" />
              <span className="text-xs">Lifeline</span>
            </div>
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-yellow-50 hover:bg-yellow-100 transition-colors"
              draggable
        ...
        return (
          <div className="grid grid-cols-2 gap-2">
            <div
              ...
              draggable
              onDragStart={(e) => onDragStart(e, "activity", { name: "Activity", type: "action" })}
            >
            ...
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-orange-50 hover:bg-orange-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "activity", { name: "Decision", type: "decision" })}
            >
            ...
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-orange-50 hover:bg-orange-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "activity", { name: "Start", type: "start" })}
            >
            ...
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-orange-50 hover:bg-orange-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "activity", { name: "End", type: "end" })}
            >
        ...
        return (
          <div className="grid grid-cols-2 gap-2">
            ...
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-purple-50 hover:bg-purple-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "state", { name: "Initial", type: "initial" })}
            >
              <Circle className="h-8 w-8 fill-black" />
            ...
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-purple-50 hover:bg-purple-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "state", { name: "Final", type: "final" })}
            >
              <Circle className="h-8 w-8 border-4" />
        ...
        return (
          <div className="grid grid-cols-2 gap-2">
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-cyan-50 hover:bg-cyan-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "object", { name: "Object" })}
            >
              <Box className="h-8 w-8 text-cyan-600" />
        ...
        return (
          <div className="grid grid-cols-2 gap-2">
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-cyan-50 hover:bg-cyan-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "timeline", { name: "Timeline" })}
            >
        ...
        return (
          <div className="grid grid-cols-2 gap-2">
            <div
              className="flex flex-col items-center gap-1 p-3 border rounded-lg cursor-grab touch-manipulation bg-orange-50 hover:bg-orange-100 transition-colors"
              draggable
              onDragStart={(e) => onDragStart(e, "activity", { name: "Frame", type: "frame" })}
            >
